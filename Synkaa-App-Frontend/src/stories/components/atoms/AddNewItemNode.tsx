...
import addInteractionWhite from "../../../../src/assets/images/addInteractionWhite.svg";
...
function AddNewItemNode({ setNodes, setEdges,data }: any) {
    ...
    return (
        <>
            <Box className="nodrag" sx={{ width: "325px", height: "auto", bgcolor: "#fff", overflow: "hidden" }}>

                <Box
                    sx={{ bgcolor: "#01CBD5", width: "auto", px: "16px", borderRadius: "4px", display: 'flex', justifyContent: "flex-start" }}>
                    <Button sx={{ maxWidth: "auto", flex: "1", p: "0" }}>
                        <Typography sx={{ color: "#ffffff", fontSize: "14px", fontWeight: "500", textAlign: "start", width: "100%" }}>{data.text}</Typography>
                    </Button>
